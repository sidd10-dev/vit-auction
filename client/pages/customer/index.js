          ...
          <div className="mx-auto w-full rounded-2xl bg-white p-2">
            ...
            <div className="m-3">
              <Disclosure>
                {({ open }) => (
                  <>
                    <Disclosure.Button className="p-1 flex w-full justify-between items-center rounded-lg bg-sky-800 px-4 py-2 text-left text-sm font-medium text-sky-200 hover:bg-sky-900">
                    ...
                    >
                      <div className="px-4 pt-4 pb-2 text-sm text-gray-500">
                        ...
                        <div className="mt-4">
                          ...
                          <div className="p-4 my-4 flex flex-row items-center text-white bg-indigo-400 rounded-lg">
                            <div className="w-full">
                              <div className="flex flex-row items-center">
                                <h1 className="text-lg font-medium m-1">Component Name:</h1>
                                <p className="text-base m-1">
                                  Premium Plastic
                                </p>
                              </div>
                              ...
                              <div className="flex flex-row items-center">
                                <h1 className="text-lg font-medium m-1">Asking Price:</h1>
                                <p className="text-base m-1">
                                  10000 Rs.
                                </p>
                              </div> 
                              <div className="flex flex-row items-center">
                                <h1 className="text-lg font-medium m-1">Industry:</h1>
                                <p className="text-base m-1">
                                  Hardware
                                </p>
                              </div>
                            ...
                            <button
                              type="button"
                              className="w-24 rounded-lg flex justify-center items-center bg-indigo-800 p-1.5 text-white text-sm hover:bg-indigo-700"
                          ...
                          <div className="p-4 my-4 flex flex-row items-center text-white bg-indigo-400 rounded-lg">
                            <div className="w-full">
                              ...
                              <div className="flex flex-col items-center pr-2 sm:flex-row justify-between">
                                <div className="flex flex-row items-center">
                                  <h1 className="text-lg font-medium m-1">Company:</h1>
                                  <p className="text-base m-1">
                                    Hewlett-Packard Ltd.
                                  </p>
                                </div>
                                <div className="flex flex-row items-center">
                                  <h1 className="text-lg font-medium m-1">Agreed Price:</h1>
                                  <p className="text-base m-1">
                                    20000 Rs.
                                  </p>
                                </div>
                            ...
                            <div className="w-24 flex justify-center">
                              <CheckCircleIcon
                                className="w-8 h-8 fill-green-400 bg-white rounded-full"
                              />
                            </div>
                          </div>
